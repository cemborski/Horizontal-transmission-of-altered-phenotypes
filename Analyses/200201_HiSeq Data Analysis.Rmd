...
resultsNames(ddse1)
#Contrasts:
res0 <- results(ddse1, contrast=c("GenTreat","F0CD","F0NSD"))
...
res0$genus <- gsub("D5", "", tax_table(psF.gut)[rownames(res0)])
res0
res0[res0$padj < 0.05, c("genus", "log2FoldChange", "padj")]
res01 <- res0[rownames(res1)[which(res1$padj<0.05)],"padj"]
```
